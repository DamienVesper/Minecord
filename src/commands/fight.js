...
module.exports.run = async(client, message, args) => {
    ...
    let fleshPickup, bonesPickup, stringPickup, gunpowderPickup, pearlsPickup, shellsPickup;
    ...
    switch(dbUser.equipped.sword) {
        ...
        case 4:
            ...
            break;
        case 5:
            shellsPickup = rng(10, 16);
    
            dbUser.drops.shulkerShells += shellsPickup;
    
            pickupTxt += `a shulker ${emojis.shulker} with your ${emojis.netheriteSword} and got ${shellsPickup} ${emojis.shulkerShell}`;
            break;
    }
